        ...
        <>
            <div className="exercise-box chat-exercise-box">
                ...
                <div className="chat-message-list" ref={messageListRef}>
                    {messages.map((msg) => {
                         const userMsgClass = msg.sender === 'user' 
                            ? `chat-message user ${msg.timestamp === sentMessageId ? 'sent-animation' : ''}` 
                            : `chat-message ${msg.sender}`;

                        if (msg.type === 'image') {
                            return (
                                <div key={msg.timestamp} className="chat-message system">
                                ...
                                <div key={msg.timestamp} className="chat-message system">
                                    <div className="feedback-container">
                                        <div className="feedback-card">
                                            <h5>{t('exercise.feedback.like')}</h5>
                                            <p>{msg.feedback.like}</p>
                                        </div>
                                        <div className="feedback-card">
                                            <h5>{t('exercise.feedback.wish')}</h5>
                                            <p>{msg.feedback.wish}</p>
                                        </div>
                                        <div className="feedback-card">
                                            <h5>{t('exercise.feedback.whatIf')}</h5>
                                            <p>{msg.feedback.whatIf}</p>
                                        </div>
                                    </div>
                                </div>
                            );
                        ...
                        return (
                            <div key={msg.timestamp} className={userMsgClass}>
